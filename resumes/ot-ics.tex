% ============================================================
%  VARAKUMAR G  —  Résumé (Sector base: OT/ICS Security)
...
Security Engineer with 2+ years in \textbf{ICS/OT security}, working hands-on with \textbf{Modbus}, \textbf{BACnet}, \textbf{EtherNet/IP}, \textbf{DNP3}, and \textbf{PROFINET} across products from \textbf{Siemens}, \textbf{Schneider Electric}, \textbf{Rockwell Automation}, \textbf{ABB}, \textbf{Emerson}, and \textbf{Honeywell}. Grew \textbf{OT/SCADA CVE coverage from ~400 to 3,200+} within a year — a \textbf{700\%} increase — and remediated \textbf{2,800+ CVEs} solo, triaging each with \textbf{CVSS} scoring, false-positive analysis, and risk-based prioritization against \textbf{NIST CSF} and \textbf{CIS Benchmarks}.
...
\techrow{Security Domains:}{ICS/OT Security, Vulnerability Management, Detection Engineering, Cloud Security}
\techrow{OT/ICS \& Industrial Protocols:}{Modbus, BACnet, EtherNet/IP, DNP3, PROFINET}
\techrow{Vulnerability \& Cloud Scanning:}{Nessus, OpenVAS, NASL, Qualys, CloudSploit, NVD, CVSS, AWS, Azure, GCP, Oracle}
...
\begin{itemize}
  \item Grew \textbf{OT/SCADA CVE coverage from ~400 to 3,200+} within a year — a \textbf{700\% increase} in the
        company's SCADA/OT security coverage for clients — validating each vulnerability against real vendor
        advisories and the underlying industrial protocol.
  \item Assessed OT security products from \textbf{Siemens}, \textbf{Schneider Electric}, \textbf{Rockwell Automation},
        \textbf{ABB}, \textbf{Emerson}, and \textbf{Honeywell} across \textbf{Modbus}, \textbf{BACnet},
        \textbf{EtherNet/IP}, \textbf{DNP3}, and \textbf{PROFINET}.
  \item Triaged every finding with \textbf{CVSS} scoring, false-positive analysis, and risk-based prioritization,
        then reported it to clients with remediation guidance and re-validated the fix.
  \item Managed the \textbf{CloudSploit platform end-to-end} across \textbf{AWS}, \textbf{Azure}, \textbf{GCP}, and
        \textbf{Oracle} against \textbf{CIS Benchmark} controls, contributing reviewed fixes upstream.
  \item Automated OT plugin development using \textbf{Claude AI}, cutting manual authoring effort as new CVEs landed.
\end{itemize}
