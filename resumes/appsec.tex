% ============================================================
%  VARAKUMAR G  —  Résumé (Sector base: AppSec / API Security)
...
Security Engineer with 2+ years in \textbf{application and API security} — manual exploitation, \textbf{secure code review}, and \textbf{SAST}/\textbf{DAST} across web apps and APIs. Assessed and exploited a live billing application end-to-end (\textbf{IDOR}, \textbf{privilege escalation}, \textbf{SQL injection}, \textbf{XSS}, weak \textbf{JWT} handling) and reported it via a \textbf{GitHub Security Advisory}. Tests \textbf{API security} against \textbf{crAPI}/\textbf{VAmPI} with \textbf{Burp Suite} and \textbf{Postman}, scoring findings with \textbf{CVSS} and working to \textbf{OWASP Top 10}, \textbf{PCI-DSS}, and \textbf{ISO 27001}.
...
\techrow{Security Domains:}{Application Security, API Security, Secure Code Review, SAST/DAST, Vulnerability Management, Cloud Security}
\techrow{AppSec \& API Testing:}{Burp Suite, Postman, crAPI, VAmPI, Metasploit, Nmap, Wireshark, Hashcat}
...
\begin{itemize}
  \item Grew \textbf{OT/SCADA CVE coverage from ~400 to 3,200+} within a year — a \textbf{700\% increase} — across
        ...
        \textbf{Emerson}, and \textbf{Honeywell}.
  \item Managed the \textbf{CloudSploit platform end-to-end} across \textbf{AWS}, \textbf{Azure}, \textbf{GCP}, and
        \textbf{Oracle} against \textbf{CIS Benchmark} controls, reviewing and contributing security fixes upstream
        to the open-source codebase.
  \item Automated development and validation of vulnerability and \textbf{API security} checks using
        \textbf{Claude AI}, reviewing every generated check before it shipped.
  \item Reported findings to clients with \textbf{CVSS}-scored severity, remediation guidance, and re-validation
        after fixes.
\end{itemize}
