% ============================================================
%  VARAKUMAR G  —  Résumé (Sector base: Vulnerability Management)
...
Security Engineer with 2+ years in \textbf{Vulnerability Management} — \textbf{CVSS}-based triage, validation, false-positive analysis, risk-based prioritization, remediation guidance, and re-validation across cloud and \textbf{OT/ICS} estates. Grew \textbf{OT/SCADA CVE coverage from ~400 to 3,200+} within a year — a \textbf{700\%} increase — across \textbf{Siemens}, \textbf{Schneider Electric}, \textbf{Rockwell Automation}, \textbf{ABB}, \textbf{Emerson}, and \textbf{Honeywell}, and ran \textbf{CloudSploit} posture management across AWS/Azure/GCP/Oracle to \textbf{CIS Benchmark}, \textbf{PCI-DSS}, and \textbf{ISO 27001} requirements. Validates exploitability directly through web app and \textbf{Active Directory} testing, so risk ratings reflect real exploit conditions.
...
\techrow{Security Domains:}{Vulnerability Management, Vulnerability Assessment, Cloud Security, ICS/OT Security, Secure Code Review}
\techrow{Vulnerability Scanning \& Management:}{Nessus, OpenVAS, Qualys, CloudSploit, NVD, CVSS, Custom Scripts}
\techrow{Cloud \& OT/ICS:}{AWS, Microsoft Azure, GCP, Oracle Cloud, Modbus, BACnet, EtherNet/IP, DNP3, PROFINET}
\techrow{Network \& Security Protocols:}{IPsec, Kerberos, LDAP, TLS/SSL, DNS, DHCP, SNMP, SMB, RDP, SSH, HTTP/HTTPS}
\techrow{Exploitation \& Security Testing:}{Metasploit, Burp Suite, Nmap, Wireshark, Postman, crAPI, VAmPI, Hashcat}
...
\begin{itemize}
  \item Grew \textbf{OT/SCADA CVE coverage from ~400 to 3,200+} within a year — a \textbf{700\% increase} in the
        company's SCADA/OT security coverage for clients — across products from \textbf{Siemens},
        \textbf{Schneider Electric}, \textbf{Rockwell Automation}, \textbf{ABB}, \textbf{Emerson}, and \textbf{Honeywell}.
  \item Triaged every finding end-to-end: \textbf{CVSS} scoring, validation against vendor advisories,
        false-positive analysis, and risk-based prioritization so remediation effort tracked real exploitability.
  \item Managed the \textbf{CloudSploit platform end-to-end} across \textbf{AWS}, \textbf{Azure}, \textbf{GCP}, and
        \textbf{Oracle}, enforcing \textbf{CIS Benchmark} compliance and contributing reviewed fixes upstream.
  \item Automated vulnerability-check development using \textbf{Claude AI}, cutting manual plugin-authoring effort
        as new CVEs landed.
